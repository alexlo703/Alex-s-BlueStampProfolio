...
To put everything togehter, I had to attach the raspberry pi and camera to my glass. To do this, I first 3D printed out a case that I built for the camera. I design the case and built it out on onshape. My case allows the camera to slide into the case, making it easy to take the camera on and off. With the case, it is easier hotgled the case onto the glasses. THe case is placed in the middle of the glasses, so it can directly point to where you are looking at while not blocking you vision. 
